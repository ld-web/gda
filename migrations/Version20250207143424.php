...
final class Version20250207143424 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stapling_rule (id INT AUTO_INCREMENT NOT NULL, stapling_config_id INT DEFAULT NULL, glue_operator VARCHAR(255) NOT NULL, comparison_operator VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, metadata_enum VARCHAR(255) NOT NULL, INDEX IDX_2E41CA93DF339496 (stapling_config_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
